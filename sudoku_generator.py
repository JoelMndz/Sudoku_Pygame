...
class SudokuGenerator:
    ...
    def fill_box(self, row_start, col_start):
      for i in range(row_start,row_start+3):
        for j in range(col_start,col_start+3):
          ...
          while not self.is_valid(i,j,number):
            number = random.randint(1,9)
  ...
  # def find_empty_cell(self, matrix, position):
  #   for i in range(self.__row_length):
  #     for j in range(self.__row_length):
  #       if matrix[i][j] == 0:
  #         position[0] = i
  #         position[1] = j
  #         return True
  ...
  # def fill_remaining_recursive(self, matrix):
  #   position = [0,0]

  #   if self.find_empty_cell(matrix,position) == False:
  #     return True
  ...
  #       if self.fill_remaining_recursive(matrix):
  #         return True
